...
export const PUBLIC_CONTENT_ROUTES: SmokeRoute[] = [
  ...
  { path: '/music/albums/all', titlePattern: /Albums/i },
  { path: '/music/trending', titlePattern: /Trending/i },
  { path: '/music/all', titlePattern: /All Music|Music/i },
  ...
  { path: '/videos/all', titlePattern: /All Videos|Videos/i },
  { path: '/news', titlePattern: /News/i },
  { path: '/news/all', titlePattern: /All Stories|News/i },
