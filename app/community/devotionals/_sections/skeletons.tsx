...
export function DailyDevotionalsSectionSkeleton() {
  return (
...
export function BibleStudySeriesSectionSkeleton() {
  return (
    <SectionSkeleton>
      <SectionHeaderSkeleton />
...
export function PrayerPointsSectionSkeleton() {
  return <DailyDevotionalsSectionSkeleton />;
}

export function LivingTipsSectionSkeleton() {
  return <DailyDevotionalsSectionSkeleton />;
}

export function MarriageFamilySectionSkeleton() {
  return <DailyDevotionalsSectionSkeleton />;
}
