...
import { Play, Clock, Newspaper } from 'lucide-react';
...
import { NEWS_VIDEO_BROWSE_GRID_CLASS } from '@/lib/utils/newsBrowse';
  ...
  return (
    <>
      ...
      {videoNews.length === 0 ? (
        ...
        <ContentBrowseList pagination={pagination} gridClassName={NEWS_VIDEO_BROWSE_GRID_CLASS}>
