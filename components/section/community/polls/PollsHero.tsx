      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.h1
            ...
            Polls & <span className="gradient-text">Voting</span>
          </motion.h1>
          ...
          <motion.p
            ...
            Share your opinion, participate in community polls, and see what others think. Your
            voice matters in shaping our community.
          </motion.p>
          ...
          <motion.div
            ...
            <Button
              ...
              className="gap-2"
              onClick={() => {
                document.getElementById('create-poll')?.scrollIntoView({ behavior: 'smooth' });
              }}>
