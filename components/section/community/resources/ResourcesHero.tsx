      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.p
            ...
            Download free e-books, sermon templates, beats, wallpapers, and explore affiliate
            products. Everything you need to support your ministry and faith journey.
          </motion.p>
          ...
          <motion.div
            ...
            <Button variant="hero" size="lg" className="gap-2" asChild>
              <Link href="/community/resources/all">
            ...
            <Button
              ...
              size="lg"
              className="gap-2"
              onClick={() => router.push('/community/resources/all?type=affiliate')}>
