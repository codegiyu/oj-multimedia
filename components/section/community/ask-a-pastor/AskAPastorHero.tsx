      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.h1
            ...
            Ask a <span className="gradient-text">Pastor</span>
          </motion.h1>
          ...
          <motion.p
            ...
            Get biblical guidance and answers to your questions from experienced pastors. Browse
            answered questions or submit your own.
          </motion.p>
