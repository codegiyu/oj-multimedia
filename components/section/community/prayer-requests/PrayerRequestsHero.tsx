      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.h1
            ...
            Prayer <span className="gradient-text">Requests</span>
          </motion.h1>
          ...
          <motion.p
            ...
            Share your prayer needs, pray for others, and witness the power of prayer together. We
            believe in the strength of community prayer.
          </motion.p>
