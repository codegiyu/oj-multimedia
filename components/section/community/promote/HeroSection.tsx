...
import { Music, Upload, Star, Handshake } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.h1
            ...
            Grow Your <span className="gradient-text">Audience</span>
          </motion.h1>
          ...
          <motion.p
            ...
            Promote your songs, upload sermons, get featured, and explore sponsorship opportunities.
            Reach thousands of listeners and grow your ministry.
          </motion.p>
