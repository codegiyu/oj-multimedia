...
import { Users, MessageCircle, Sparkles, Heart } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.h1
            ...
            Connect, Share & <span className="gradient-text">Be Inspired</span>
          </motion.h1>
          ...
          <motion.p
            ...
            Join conversations, share your story, find inspiration, and explore topics that matter
            to you. Your voice belongs here.
          </motion.p>
